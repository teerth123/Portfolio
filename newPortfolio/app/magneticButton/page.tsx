    ...
    <>
      <div className="h-screen w-screen flex justify-center items-center ">
        <div className="relative">
          <motion.div className="absolute w-full h-full bg-white/20 rounded-lg z-0" style={{ x: layer1X, y: layer1Y, top: "6px", left: "6px" }} />
          <motion.div className="absolute w-full h-full bg-white/40 rounded-lg z-10" style={{ x: layer2X, y: layer2Y, top: "3px", left: "3px" }} />
          <motion.div className="absolute w-full h-full bg-white/60 rounded-lg z-20" style={{ x: layer3X, y: layer3Y, top: "1px", left: "1px" }} />
          <motion.div
