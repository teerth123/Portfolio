...
export default function Middle() {
  ...
  return (
    ...
    //         Hi, I'm <span className="font-Bebas_new">Teerth Kulkarni</span>, a 3rd-year BTech student at Walchand College of Engineering,
    ...
    <>
      <img
          ...
          alt="PFP"
        />
      <h1 className="Name">Teerth Kulkarni</h1>
      <h2 className="Post">Full Stack Web Developer</h2>
      <span>
          <h3 className="Links ">
            <span className="mr-1" onMouseEnter={()=>handleHover()} onMouseLeave={()=>handleLeave()}>Github /</span>
            <span  className="m-1" onMouseEnter={()=>handleHover()} onMouseLeave={()=>handleLeave()}>Linkeding /</span>
            <span  className="m-1" onMouseEnter={()=>handleHover()} onMouseLeave={()=>handleLeave()}>Twitter /</span>
            <span  className="m-1" onMouseEnter={()=>handleHover()} onMouseLeave={()=>handleLeave()}>YouTube /</span>
            <span  className="m-1" onMouseEnter={()=>handleHover()} onMouseLeave={()=>handleLeave()}>Email /</span>
            <span  className="m-1" onMouseEnter={()=>handleHover()} onMouseLeave={()=>handleLeave()}>Resume</span>
          </h3>
      </span>
      <h3 className="Para my-8">Hi, I’m <span className="font-roboto underline">Teerth Kulkarni</span>, a 3rd-year BTech student at Walchand College of Engineering, Sangli. I love coding, chess (1600+ on Chess.com), and sketching. With a 98.97%ile in MHTCET and 300+ DSA problems solved, balancing my left-brained creativity with right-brained logic has taken me this far in my journey.</h3>
      <h3 className="Heading">Work Experience</h3>
      <div className="">
        <h3 className="Projects ">Freelancing</h3>
        <h3 className="Para">Piramal Revanta</h3>
      </div>
      
      <h3 className="Heading">Projects</h3>
      <div className="">
        <h3 className="Projects ">Paytm Clone</h3>
        <h3 className="Para"> Profile creation, user search, secure transactions, and rollback on transaction failure.</h3>
      </div>
      <div className="">
        <h3 className="Projects ">Chess.com Analytics</h3>
        <h3 className="Para">Heatmap for chess.com users to track consistency and other analytical options.</h3>
      </div>
      <div className="">
        <h3 className="Projects ">YouTube Clone</h3>
        <h3 className="Para">Clean YouTube clone with dark mode and redesigned UI, no Sign-in required.</h3>
      </div>
